...
import type { ByteView, MultihashDigest, Phantom } from "../types.js";
import type { Multibase, MultibaseEncoder } from "./coders.js";
...
export interface LegacyLink<T extends unknown = unknown>
  extends Link<T, DAG_PB, SHA_256, 0> {}

export type UnknownLink =
  | LegacyLink<unknown>
  | Link<unknown, number, number, Version>;

export type ToString<T, Prefix extends string = string> = Multibase<Prefix> &
  Phantom<T>;
